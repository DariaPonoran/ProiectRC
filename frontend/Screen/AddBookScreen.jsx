...
const AddBookScreen = () => {
  ...
  const uploadImage = async () => {
    ...
    if (!images.canceled) {
      ...
      const res = await fetch(`${apiurl}/images/uploadimage2`, {
        method: 'POST',
        headers: {
  ...
  return (
    <SafeAreaView style={tw('flex-1 px-4')}>
      <KeyboardAvoidingView style={tw('flex-1')}>
        <Text style={tw('text-2xl font-bold text-blue-500 mx-auto my-2')}>
          New Book
        </Text>
        ...
        <TextInput
          ...
          placeholder='title...'
          style={tw(
            'rounded-full w-full  mb-4 py-2 px-4 w-full bg-gray-300 text-base'
          )}
        ></TextInput>
        <TextInput
        ...
        ></TextInput>
        <TextInput
          onChangeText={(text) => setCopiesAvailable(text)}
          keyboardType='numeric'
        ...
        <Button
          onPress={uploadImage}
          buttonStyle={tw(
            'w-full mx-auto rounded-full mb-8 py-2 text-white bg-blue-500'
          )}
          title='Add Image'
        ></Button>
        <Button
          ...
          buttonStyle={tw(
            'w-full mx-auto rounded-full  py-2 text-white bg-blue-500'
          )}
          title='Create Book'
        ></Button>
      </KeyboardAvoidingView>
